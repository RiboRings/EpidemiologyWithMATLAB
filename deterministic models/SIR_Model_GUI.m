function SIR_Model_GUI
    ...
    pR = plot(tSol, R, 'g', 'LineWidth', 2, 'LineStyle', "-");

    axis([tRange, 0, N])
    legend('S(t), susceptible', 'I(t), infected', 'R(t), recovered', 'Location', 'east')

    xlabel('time')
    ylabel('number of people')

    title({'\textbf{The SIR Model:} \quad $$\dot{S}=-\beta\, SI,\quad\dot{I}=\beta SI-\gamma I,\quad \dot{R}=\gamma I$$'}, 'interpreter', 'latex', 'FontSize', 12);
    hold off
